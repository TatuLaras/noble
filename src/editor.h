...
// Instantiates an entity with the current asset at `ray` intersection point and
// adds it to light group `handle`.
...
// Adjusts the ground plane / grid height, also used as the ground when adding
// lights or entities.
