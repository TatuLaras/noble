...
typedef enum {
    ...
    ACTION_START_PICKING_TERRAIN_TEXTURE,
    ...
    ACTION_TERRAIN_SLOT_1,
    ACTION_TERRAIN_SLOT_2,
    ACTION_TERRAIN_SLOT_3,
    ACTION_TERRAIN_SLOT_4,
    ACTION_TERRAIN_SLOT_5,
    ACTION_TERRAIN_SLOT_6,
    ACTION_TERRAIN_SLOT_7,
    ACTION_TERRAIN_TOOL_RAISE,
    ACTION_TERRAIN_TOOL_RAISE_SMOOTH,
    ACTION_TERRAIN_TOOL_SET,
